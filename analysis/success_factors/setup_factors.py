...
DEFAULT_TABLE_SPECS: list[dict[str, Any]] = [
    ...
    {
        "category": "probing",
        "relative_path": Path("analysis/success_factors/results/probing/probing_subject_finger_stiffness_summary.csv"),
...
def _default_paths() -> tuple[Path, Path]:
    ...
    return repo_root, repo_root / "analysis" / "success_factors" / "results" / "setup_factors"
